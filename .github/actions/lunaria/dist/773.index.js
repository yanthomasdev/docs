...
/* harmony import */ var node_readline__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(481);
/* harmony import */ var node_tty__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7066);
/* harmony import */ var _shared_consola_36c0034f_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3404);
/* harmony import */ var tty__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(2018);
/* harmony import */ var _utils_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9797);
/* harmony import */ var _core_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(4231);
/* harmony import */ var _shared_consola_06ad8a64_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(8925);
/* harmony import */ var node_util__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(7975);
/* harmony import */ var node_path__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(6760);
...
const symbol = (state) => {
  switch (state) {
    case "initial":
    case "active": {
      return _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.cyan(S_STEP_ACTIVE);
    }
    case "cancel": {
      return _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.red(S_STEP_CANCEL);
    }
    case "error": {
      return _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.yellow(S_STEP_ERROR);
    }
    case "submit": {
      return _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.green(S_STEP_SUBMIT);
    }
  }
};
const text = (opts) => {
  return new oD({
    ...
    render() {
      const title = `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.gray(S_BAR)}
${symbol(this.state)} ${opts.message}
`;
      const placeholder = opts.placeholder ? _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.inverse(opts.placeholder[0]) + _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.dim(opts.placeholder.slice(1)) : _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.inverse(_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.hidden("_"));
      const value = this.value ? this.valueWithCursor : placeholder;
      switch (this.state) {
        case "error": {
          return `${title.trim()}
${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.yellow(
            S_BAR
          )} ${value}
${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.yellow(S_BAR_END)} ${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.yellow(
            this.error
          )}
`;
        }
        case "submit": {
          return `${title}${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.gray(S_BAR)} ${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.dim(
            this.value || opts.placeholder
          )}`;
        }
        case "cancel": {
          return `${title}${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.gray(S_BAR)} ${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.strikethrough(
            _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.dim(this.value ?? "")
          )}${this.value?.trim() ? "\n" + _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.gray(S_BAR) : ""}`;
        }
        default: {
          return `${title}${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.cyan(S_BAR)} ${value}
${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.cyan(
            S_BAR_END
          )}
`;
        }
...
`;
      ...
      switch (this.state) {
        case "submit": {
          return `${title}${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.gray(S_BAR)} ${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.dim(value)}`;
        }
        case "cancel": {
          return `${title}${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.gray(S_BAR)} ${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.strikethrough(
            _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.dim(value)
          )}
${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.gray(S_BAR)}`;
        }
        default: {
          return `${title}${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.cyan(S_BAR)} ${this.value ? `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.green(S_RADIO_ACTIVE)} ${active}` : `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.dim(S_RADIO_INACTIVE)} ${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.dim(active)}`} ${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.dim("/")} ${this.value ? `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.dim(S_RADIO_INACTIVE)} ${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.dim(inactive)}` : `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.green(S_RADIO_ACTIVE)} ${inactive}`}
${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.cyan(S_BAR_END)}
`;
        }
      }
    }
...
const select = (opts) => {
  const opt = (option, state) => {
    ...
    switch (state) {
      case "active": {
        return `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.green(S_RADIO_ACTIVE)} ${label} ${option.hint ? _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.dim(`(${option.hint})`) : ""}`;
      }
      case "selected": {
        return `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.dim(label)}`;
      }
      case "cancelled": {
        return `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.strikethrough(_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.dim(label))}`;
      }
    }
    return `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.dim(S_RADIO_INACTIVE)} ${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.dim(label)}`;
  };
  return new ED({
...
`;
      switch (this.state) {
        case "submit": {
          return `${title}${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.gray(S_BAR)} ${opt(
...
${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.gray(S_BAR)}`;
        ...
        default: {
          return `${title}${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.cyan(S_BAR)} ${this.options.map(
            (option, i) => opt(option, i === this.cursor ? "active" : "inactive")
          ).join(`
${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.cyan(S_BAR)}  `)}
${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.cyan(S_BAR_END)}
`;
        }
      }
...
const multiselect = (opts) => {
  const opt = (option, state) => {
    ...
    switch (state) {
      case "active": {
        return `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.cyan(S_CHECKBOX_ACTIVE)} ${label} ${option.hint ? _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.dim(`(${option.hint})`) : ""}`;
      }
      case "selected": {
        return `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.green(S_CHECKBOX_SELECTED)} ${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.dim(label)}`;
      }
      case "cancelled": {
        return `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.strikethrough(_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.dim(label))}`;
      }
      case "active-selected": {
        return `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.green(S_CHECKBOX_SELECTED)} ${label} ${option.hint ? _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.dim(`(${option.hint})`) : ""}`;
      }
      case "submitted": {
        return `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.dim(label)}`;
      }
    }
    return `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.dim(S_CHECKBOX_INACTIVE)} ${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.dim(label)}`;
  };
  return new iD({
    options: opts.options,
...
${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.reset(
          _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.dim(
            `Press ${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.gray(
              _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.bgWhite(_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.inverse(" space "))
            )} to select, ${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.gray(
              _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.bgWhite(_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.inverse(" enter "))
            )} to submit`
          )
        )}`;
      }
...
`;
      switch (this.state) {
        case "submit": {
          return `${title}${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.gray(S_BAR)} ${this.options.filter(({ value }) => this.value.includes(value)).map((option) => opt(option, "submitted")).join(_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.dim(", ")) || _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.dim("none")}`;
        }
        case "cancel": {
          const label = this.options.filter(({ value }) => this.value.includes(value)).map((option) => opt(option, "cancelled")).join(_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.dim(", "));
          return `${title}${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.gray(S_BAR)} ${label.trim() ? `${label}
${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.gray(S_BAR)}` : ""}`;
        }
        case "error": {
          const footer = this.error.split("\n").map(
            (ln, i) => i === 0 ? `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.yellow(S_BAR_END)} ${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.yellow(ln)}` : `   ${ln}`
          ).join("\n");
          return title + _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.yellow(S_BAR) + "  " + this.options.map((option, i) => {
...
${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.yellow(S_BAR)}  `) + "\n" + footer + "\n";
        }
        default: {
          return `${title}${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors */ .Tj.cyan(S_BAR)} ${this.options.map((option, i) => {
            const selected = this.value.includes(option.value);
            const active = i === this.cursor;
            if (active && selected) {
              return opt(option, "active-selected");
